...
class Cli {
  ...
  createVehicle(): void {
    inquirer
      ...
      .then((answers) => {
        ...
        else console.log('Please select a Vehicle');
      });
  }
  ...
  processVehicle(vehicle: Vehicle): void {
    if (vehicle instanceof Truck) {
      ...
      console.log('Processing truck:', vehicle);
    } else {
  ...
  findVehicleToTow(truck:Truck): void {
    inquirer
      ...
      .then((answers) => {
        ...
        console.log(`Towing vehicle: ${selectedVehicle.make} ${selectedVehicle.model}`);
      ...
      .then((answers) => {
        ...
        if (answers.action === 'Print details') {
          ...
          if (truck) {
            ...
            console.log('Can only tow a truck');
          }
